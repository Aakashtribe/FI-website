...
export default function SlashChatScreen({ active, notch, showStatusBar = true }) {
  // idle -> typing -> responding (sent query + AI reply, instant — no loading state),
  // then holds there. Plays once — no auto-loop — and only replays if the section
  // leaves the viewport and comes back (`running` going false then true again).
